...
const images = [
  ...
  const quotes = {
    ...
    en: [
      ...
      "You need to adjust appropriately",
      "Doubt it",
      ...
      "Write it down",
      "Never get caught up in your personal feelings",
      "Shift your focus",
      "Things are going very badly right now",
      ...
      "The best solution isn't obvious",
      "Stay flexible",
      ...
      "Speak it out without reservation",
      "Don't hesitate",
      "It has great significance",
      "Change the priority of important matters",
      "This is the best time to make a new plan",
      "Move forward",
      "Make a list of why not to do it",
      "Don't wait",
      ...
      "Urge to terminate",
      "Too many choices are harder than too few",
      "Yes",
      ...
      "Go all out",
      "Don't really care",
      "You need to consider other ways",
      "A year from now won't matter",
      "Don't waste your time",
      "It might be extraordinary",
      "Count to 10 and ask again",
      "Pretend it's already true",
      "Setting priorities is a must",
      "Use your imagination",
      "It will definitely be good",
      "Calm down and ensure the best decision",
      "Wait",
      "You'll need to keep making up for it when you act",
      "Laugh it off",
      "Others also depend on your choice",
      "You will regret it",
      "Beyond reproach",
      "You know it's better now than before",
      "Trust your intuition",
      "Considering its chances",
      "Ask your mother",
      ...
      "Ask your father",
      "Absolutely not",
      "The answer will come to you in another form"
    ]
  };
